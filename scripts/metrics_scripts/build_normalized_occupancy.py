"""Build the Normalized Occupancy metric and (optionally) write it to Databricks.
...
from normalized_occupancy import (  # noqa: E402
...
DEFAULT_SOURCE = "usr.danielanzures.io_occupancy_time_raw"
DEFAULT_TARGET = "usr.danielanzures.io_normalized_occupancy_metric"
